...
systemctl enable NetworkManager.service firewalld.service layersentry-privileged.service layersentry-firstboot.service layersentryd.service layersentry-maintenance.timer
