...
func(e *Engine)Plan(ctx context.Context,req model.ServiceRequest)(model.Plan,model.Operation,error){
 ...
 plan.Steps=append(storagePlanSteps(req),plan.Steps...);plan.Request=req;plan.Digest="";canonical,err:=config.PlanDigest(plan);if err!=nil{return model.Plan{},op,err};plan.Digest=canonical
