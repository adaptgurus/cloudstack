...
func validateSemanage(args []string)error{if len(args)!=5||args[0]!="fcontext"||(args[1]!="-a"&&args[1]!="-m")||args[2]!="-e"||args[3]!="/var/lib/mysql"{return errors.New("SELinux equivalence grammar rejected")};return validateDataRoot(args[4])}
