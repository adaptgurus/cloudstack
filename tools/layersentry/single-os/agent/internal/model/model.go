...
type StorageAssignment struct {
	...
	ConfirmFormat bool   `json:"confirm_format"`
}
...
type LVMVolumeGroup struct {
	...
	InitializePVs       bool               `json:"initialize_pvs"`
	ConfirmPVInitialize bool               `json:"confirm_pv_initialize"`
...
type MaintenancePolicy struct {
	...
	ReleaseLineLocked bool   `json:"release_line_locked"`
}
...
type ClusterSpec struct {
	...
	Peers               []string          `json:"peers,omitempty"`
	JoinTokenRef        string            `json:"join_token_ref,omitempty"`
	EnrollmentPeer      string            `json:"enrollment_peer,omitempty"`
	PeerTLSFingerprints map[string]string `json:"peer_tls_fingerprints,omitempty"`
...
type ServiceRequest struct {
	...
	Storage         []StorageAssignment `json:"storage,omitempty"`
	LVM             []LVMVolumeGroup    `json:"lvm,omitempty"`
...
type PlatformPackagePin struct {
	Purpose          string `json:"purpose"`
...
type Plan struct {
	...
	PlatformPackages []PlatformPackagePin `json:"platform_packages,omitempty"`
