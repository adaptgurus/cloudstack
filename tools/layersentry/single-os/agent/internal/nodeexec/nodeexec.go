...
func validateDNF(args []string)error{if len(args)==4&&args[0]=="-q"&&args[1]=="config-manager"&&args[2]=="--dump"&&args[3]=="appstream"{return nil};if len(args)==5&&args[0]=="-q"&&args[1]=="module"&&args[2]=="repoquery"&&args[3]=="--available"&&args[4]=="nodejs:20"{return nil};if len(args)==5&&args[0]=="-q"&&args[1]=="module"&&args[2]=="list"&&args[3]=="--enabled"&&args[4]=="nodejs"{return nil};if len(args)==5&&args[0]=="-y"&&args[1]=="module"&&args[2]=="enable"&&args[3]=="nodejs:20"&&args[4]=="--allowerasing"{return nil};if len(args)==4&&args[0]=="-y"&&args[1]=="module"&&args[2]=="reset"&&args[3]=="nodejs"{return nil};if len(args)==6&&args[0]=="-y"&&args[1]=="--setopt=install_weak_deps=False"&&args[2]=="--disablerepo=*"&&args[3]=="--enablerepo=appstream"&&args[4]=="install"&&nodeNEVRA.MatchString(args[5]){return nil};if len(args)==3&&args[0]=="-y"&&args[1]=="remove"&&args[2]=="nodejs"{return nil};return errors.New("Node.js DNF grammar rejected")}
