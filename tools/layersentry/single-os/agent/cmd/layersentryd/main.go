...
import (
	...
	nginxbase "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/nginx"
	nodeprovider "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/nodejsmodule"
	pgprovider "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/pgmanaged"
	pgbase "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/postgresql"
	runtimeprovider "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/runtime"
	tomcatbase "github.com/adaptgurus/cloudstack/tools/layersentry/single-os/agent/providers/tomcat"
)
...
func buildRuntime()(*runtimeState,error){
 ...
 reg:=provider.NewRegistry();providers:=[]provider.Provider{pg,mysqlManaged,mariaManaged,redisManaged,valkeyManaged,nginxManaged,apacheManaged,tomcatManaged,nodeprovider.New(nodeRunner),pythonOwned,podmanOwned};for _,p:=range providers{if err=reg.Register(p);err!=nil{return nil,err}}
